...
//C:\Program Files\Unity\Editor\Data\CGIncludes
		...
		// shader side buffer struct:
			...
			struct BranchCylinder
			{

				float3 position; // the position of the  cylinder origin in the boid reference frame        
                float  height;

                float  radius; // the radius of the cylinder
                float4 color;         // RGBA color of the cylinder; This color is a weighted sum of the colors of the neighbor
   ...
   //          
			...
			StructuredBuffer<BranchCylinder> _CylinderBuffer;
        #endif
